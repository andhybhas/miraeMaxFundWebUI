...
String scenario = '001. Mutual Funds'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioMutualFunds')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Mutual Funds'), [:])