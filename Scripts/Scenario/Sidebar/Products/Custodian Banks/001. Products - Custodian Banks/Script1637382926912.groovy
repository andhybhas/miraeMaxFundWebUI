...
String scenario = '001. Custodian Banks'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioCustodianBanks')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Custodian Banks'), [:])