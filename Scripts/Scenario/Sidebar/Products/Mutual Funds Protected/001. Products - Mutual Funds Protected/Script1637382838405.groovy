...
String scenario = '001. Mutual Funds Protected'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioMutualFundsProtected')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Mutual Funds Protected'), [:])