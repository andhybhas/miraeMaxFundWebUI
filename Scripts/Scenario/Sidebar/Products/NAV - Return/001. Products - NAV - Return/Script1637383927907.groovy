...
String scenario = '001. NAV - Return'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioNAVReturn')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - NAV - Return'), [:])