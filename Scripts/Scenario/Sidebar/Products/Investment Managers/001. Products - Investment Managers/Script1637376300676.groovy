...
String scenario = '001. Investment Managers'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioInvestmentManagers')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Investment Managers'), [:])