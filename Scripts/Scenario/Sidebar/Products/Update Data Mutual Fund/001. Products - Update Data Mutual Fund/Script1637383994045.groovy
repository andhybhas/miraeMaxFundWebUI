...
String scenario = '001. Update Data Mutual Fund'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioUpdateDataMutualFund')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Update Data Mutual Fund'), [:])