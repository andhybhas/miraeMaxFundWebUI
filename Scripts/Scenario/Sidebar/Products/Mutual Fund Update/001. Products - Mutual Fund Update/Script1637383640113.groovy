...
String scenario = '001. Mutual Fund Update'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioMutualFundUpdate')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Mutual Fund Update'), [:])