...
String scenario = '001. Custodian Bank Update'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioCustodianBankUpdate')
...
WebUI.callTestCase(findTestCase('Page/Web/Products - Custodian Bank Update'), [:])