...
String scenario = '001. Transactions'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioTransactions')
...
WebUI.callTestCase(findTestCase('Page/Web/Transaction - Transactions'), [:])