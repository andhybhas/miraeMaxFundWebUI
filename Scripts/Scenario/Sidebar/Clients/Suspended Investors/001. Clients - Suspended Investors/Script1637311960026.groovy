...
String scenario = '001. Suspended Investors'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioSuspendedInvestors')
...
WebUI.callTestCase(findTestCase('Page/Web/Clients - Suspended Investors'), [:])