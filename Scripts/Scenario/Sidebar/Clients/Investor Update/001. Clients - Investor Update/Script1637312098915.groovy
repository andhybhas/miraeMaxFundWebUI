...
String scenario = '001. Investor Update'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioInvestorUpdate')
...
WebUI.callTestCase(findTestCase('Page/Web/Clients - Investor Update'), [:])