...
String scenario = '001. On Validation Applicants'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioOnValidationApplicants')
...
WebUI.callTestCase(findTestCase('Page/Web/Clients - On Validation Applicants'), [:])