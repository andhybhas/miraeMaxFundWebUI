...
String scenario = '001. Batch Orders'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioBatchOrders')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - Batch Orders'), [:])