...
String scenario = '001. Orders'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioRejectedOrders')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - Rejected Orders'), [:])