...
String scenario = '001. Outstanding Orders'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioOutstandingOrders')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - Outstanding Orders'), [:])