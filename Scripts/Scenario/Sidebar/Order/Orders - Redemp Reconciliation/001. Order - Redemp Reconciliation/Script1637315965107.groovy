...
String scenario = '001. Redemp Reconciliation'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioRedemp Reconciliation')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - Redemp Reconciliation'), [:])