...
String scenario = '001. List of Portfolios'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioListofPortfolios')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - List of Portfolios'), [:])