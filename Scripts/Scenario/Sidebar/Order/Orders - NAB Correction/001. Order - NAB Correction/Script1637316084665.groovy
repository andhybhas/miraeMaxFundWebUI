...
String scenario = '001. NAB Correction'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioNABCorrection')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - NAB Correction'), [:])