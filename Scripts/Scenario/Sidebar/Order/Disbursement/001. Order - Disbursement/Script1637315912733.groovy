...
String scenario = '001. Disbursement'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioDisbursement')
...
WebUI.callTestCase(findTestCase('Page/Web/Order - Disbursement'), [:])