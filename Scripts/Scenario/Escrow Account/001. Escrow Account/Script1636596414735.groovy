...
String scenario = '001. Escrow Account'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioEscrowAccount')
...
WebUI.callTestCase(findTestCase('Page/Web/Entities - Escrow Account'), [:])
