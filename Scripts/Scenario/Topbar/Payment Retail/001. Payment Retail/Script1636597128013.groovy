...
String scenario = '001. PaymentRetail'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioPaymentRetail')
...
WebUI.callTestCase(findTestCase('Page/Web/Entities - Payment Retail'), [:])
