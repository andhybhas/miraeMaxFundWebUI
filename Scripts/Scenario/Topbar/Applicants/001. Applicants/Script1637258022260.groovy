...
String scenario = '001. Applicants'

int excelRow = 1

TestData dataTemplate = findTestData('Scenario/ScenarioApplicants')
...
WebUI.callTestCase(findTestCase('Page/Web/Clients - Applicants'), [:])
